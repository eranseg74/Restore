...
{
    public class BasketController(StoreContext context, DiscountService discountService, PaymentsService paymentsService) : BaseApiController
    {
        [HttpGet]
        ...
        public async Task<ActionResult> RemoveCouponFromBasket()
        {
            ...
            var intent = paymentsService.CreateOrUpdatePaymentIntent(basket);
            if (intent == null)
            {
